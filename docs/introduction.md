...
The MSA-Q plugin was made with the FAIR (Findable, Accessible, Interoperable, Reusable) principles of open 
...
available, and the code can be examined and contributed to by everyone (with some moderation, of course). The interface is meant to be user- and beginner friendly and does not require programming knowledge. If you use this plugin, please keep the spirit of open science in mind and share your science and data freely if you can.
